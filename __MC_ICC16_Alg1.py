...
class __MC_ICC16_Alg:
    ...
    # ===============================================
        ...
        self._linkinfodict = {} ##self.self._linkinfodict[linksrc,linkdst] = [singlelink["src"]["port_no"],singlelink["dst"]["port_no"]]  vaule is getted from Topoinfo.py  mod by gzq
    ...
    # ===================================== Begin to run =========================================
        ...
        #ryuinfo = Ryuinfo()     ##   初始化Ryuinfo，生成输入文件  mod by gzq
        #self._linkinfodict = ryuinfo._linkinfodict               ##获取switch和switch之间link的详细信息，在流表下发时 使用    mod by  gzq
    ## --- A. Read trace.
    ...
    def Check_whether_this_new_path_is_feasible_to_the_SrcCFlow(self,Src,Dst_new,Path_ID_new):
        ...
        for (u,v) in list_arcs_in_this_path:
            ...
            print "self.Cap_links[(u,v)]"+" "+ str(self.Cap_links[(u,v)])+"\n"
