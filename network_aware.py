...
###########################################################################################################################################
	self.str_file1 = "linktoportflie.txt"
	self.str_file2 = "accesshostflie.txt"
###########################################################################################################################################
...
#############################################################################################################################################
    ...
    def createtopoinfofile(self):
	self.file1 = open(str(self.str_file1),'w')
	self.file2 = open(str(self.str_file2),'w')
	self.file1.write(str(self.get_links()))
	self.file2.write(str(self.get_access_table()))
	self.file1.flush()
	self.file2.flush()
	self.file1.close()
	self.file2.close()
