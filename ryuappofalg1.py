...
class Shortest_Route(app_manager.RyuApp):
	...
	self.usemypath = False
	self.Log_debug.write("apprun_thread \n")
	...
	self.Log_debug.flush()
        ...
        self.Log_debug.write("_Cap_MBoxes&&_PathSet&&_TrafficDemands&_cap_link file create complete\n")
	self.Log_debug.flush()
	hub.sleep(90) 				
	self.Log_debug.write("hub sleep 90s end\n")  
	self.Log_debug.flush()		
 	insofrunalg = Run___MC_ICC16_Alg(self.network_monitor)
	self.Log_debug.write("_MC_ICC16_Alg1 is running\n")	
	self.Log_debug.flush()
	self._linkinfodict = ryutopoinfo._linkinfodict
    	while(True):
		self.usemypath = False	
		hub.sleep(20) 
		self.Log_debug.write("hub sleep 20s end\n")			
		self.Log_debug.flush()
		...
		self.Log_debug.write("the flow of srchost-dstmbox is designed\n")			
		self.Log_debug.flush()
		hub.sleep(80)
		self.Log_debug.write("new term\n")
		self.Log_debug.flush()					
